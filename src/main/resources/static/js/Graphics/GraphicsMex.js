    ...
    Instance.test4 = function (option, result) {
        ...
        switch (option) {
            ...
            case 4:
                ...
                if (result == 3) {
                    dataSuccesLabel = [": Login, Topup, Pin"];
                    dataFailLabel = [""];
                    dataSucces = 3;
                    dataFail = 0;
                } else if (result == 2) {
                    ...
                    dataSuccesLabel = [": Login"];
                    dataFailLabel = [": Top,Pin"];
                    dataSucces = 1;
                    dataFail = 2;
                } else if (result !== 3 && result !== 2 && result !== 1) {
                    dataSuccesLabel = [""];
                    dataFailLabel = [": Login, Topup, Pin"];
                    dataSucces = 0;
                    dataFail = 3;
                }
                drawGraph(dataSuccesLabel, dataFailLabel, dataSucces, dataFail, chartOptions, ctx);
